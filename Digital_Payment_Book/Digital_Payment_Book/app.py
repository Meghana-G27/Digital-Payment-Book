...
app.config['MYSQL_USER'] = 'HG7PKEPmT8'
app.config['MYSQL_PASSWORD'] = 'i6fZ5VdPxj'
app.config['MYSQL_DB'] = 'HG7PKEPmT8'
mysql = MySQL(app)
@app.route('/')
...
def registet():
    ...
    if request.method == 'POST' :
        ...
        if account:
            ...
            TEXT = "Hello "+username + ",\n\n"+ """Thanks for  registring as admin at DigitalPayBook """ 
...
def cusregistet():
    ...
    if request.method == 'POST' :
        ...
        if account:
            ...
            mysql.connection.commit()
            msg = 'You have successfully registered !'
            TEXT = "Hello "+username + ",\n\n"+ """Thanks for registring at DigitalPayBook """ 
            subject="digital book confirmed"
            message  = 'Subject: {}\n\n{}'.format("text", TEXT)
            sendmail(TEXT,email,subject)
...
def adpur():
    ...
    if request.method == 'POST' :
        ...
        cursor = mysql.connection.cursor()
        cursor.execute('INSERT INTO purchase VALUES ( % s, % s,% s)', (username, item ,price))
        mysql.connection.commit()
...
def email():
    ...
    if request.method == 'POST' :
        ...
        subject= sub
        message  = 'Subject: {}\n\n{}'.format("text", TEXT)
        sendmail(TEXT,"golimeghana27@gmail.com",subject)
